...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Star </b>Photo & Printting</span>
    </a>
    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fa fa-warning text-yellow"></i> Oops! Sorry the page you are going to can not access </h3>

          <p>
           Maaf halaman yang anda tuju tidak bisa di akses
          </p>
