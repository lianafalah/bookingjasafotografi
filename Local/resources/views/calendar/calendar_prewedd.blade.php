...
<div class="wrapper">
  ...
  <!-- Left side column. contains the logo and sidebar -->
      ...
      <div class="container clearfix">
        <div class="row">
          <div class="col-md-12">
            <h2 class="heading">Jadwal Prewedding Outdoor</h2>
            <div class="row">
              <div class="col-md-5">
          ...
          <div class="col-md-7">
           <form class="form-validate form-horizontal" id="feedback_form" action="{{ Route('pemesanan.store') }}" method="POST"  >
            ...
            <div class="col-md-5">
              ...
              <div class="form-group">
                <label>Lokasi</label>
                 <textarea name="lokasi" rows="3" cols="40"></textarea>
              <!--   <input class="form-control " id="tanggal_foto" type="text"  name="tanggal_foto"   /> -->
              </div>
