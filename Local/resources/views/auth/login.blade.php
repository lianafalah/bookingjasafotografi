...
<body class="hold-transition login-page" style="background-image: url('upload/gambar/mom.jpg');
  ...
  <div class="login-box-body" style="opacity: 0.9;">
    <p class="login-box-msg">Sign in to start your session</p>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('id_petugas') ? ' has-error' : '' }} has-feedback">
                          <input type="id_petugas" id="id_petugas" class="form-control" name="id_petugas" value="{{ old('id_petugas') }}" placeholder="id_petugas" required autofocus>
