                ...
                <div class="form">
                  <form class="form-validate form-horizontal" action="{{ Route('konfirmasipembayaran.store') }}" id="feedback_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="id_pesan" name="id_pesan"  type="text" value="{{ old('id_pesan') }} " />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="nama" class="control-label col-lg-2">Nama</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="nama" type="text" name="nama" required value="{{ old('nama') }} " />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for='nama_bank' class="control-label col-lg-2">Name Bank</label>
                      <div class="col-lg-10">
                        <input class="form-control" id='nama_bank' value="{{ old('nama_bank') }} " name='nama_bank' type="text" required />
