...
<div class="row">
      ...
      <div class="panel-body">
        <div class="form">
<form action="{{ Route('detailpemesanan.store') }}" method="post" enctype="multipart/form-data">
 
{{ csrf_field() }}
 
<div class="form-group">
 
<label for="Product Name">Id Pesan</label>
 
<input type="text" name="id_pesan" class="form-control"  placeholder="id_pesan" required >
 <label for="Product Name">status</label>
                  ...
                  <select name="status" id="status" class="form-control input-sm m-bot15">
                    ...
                    <option id="revisi 1">Revisi 1</option>
                    <option id="revisi 2">Revisi 2</option>
                  </select>
